                  ...
                  <div class='col-md-12'>
                      <div id='container'>
                          <form method='POST' > 
                              ...
                              <h6>Link For</h6>
                              <input type='text' class='form-control' name='in1' value='".$lf."' required /> <br>
                              ...
                              <br>
                                  ...
                                  <input type=text class='form-control' name='in3' style='  padding:20px 5px 20px 240px; font-weight:100em; width:100%;' placeholder='Custom Link Name' id='inn3' required />
