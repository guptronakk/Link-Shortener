                    ...
                    <div class='container-fluid'>
                        <div class='row'>
                            <div class='col-md-12'>
                                ...
                                <div id='container'>
                                    <form method='POST' > 
                                        <input type='text' id='in1' class='form-control alignment123' name='in1' placeholder='Link is for' value='".$lf."' required />
                                        <br>
                                        <input type='text' id='in2' class='form-control' name='in2' placeholder='Enter Original Link' value='".$ol."' required />
                                        <br>
